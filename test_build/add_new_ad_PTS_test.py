...
try:
    ...
    driver.find_element(By.XPATH,"//li/a[@href='/add/pts/cars/']").click()
    h1 = driver.find_element(By.TAG_NAME,"h1").text
    if h1 == "Разместить объявление о продаже ПТС на автомобиль":
        print('правильный раздел ПТС авто')
    else:
        print('неправильный раздел ПТС авто')
    driver.find_element(By.XPATH,"//*[@id='add']/div[1]/div/div[1]/label[2]").click()

    work(name)

    driver.find_element(By.ID,"f_firm").click()
    driver.find_element(By.XPATH,"//*[@id='f_firm']/option[5]").click()
    sleep(3)

    driver.find_element(By.ID,"f_mark").click()
    driver.find_element(By.XPATH,"//*[@id='f_mark']/option[14]").click()

    driver.find_element(By.ID,"f_year").click()
    driver.find_element(By.XPATH,"//*[@id='f_year']/option[11]").click()
