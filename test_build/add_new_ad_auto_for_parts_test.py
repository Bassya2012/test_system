...
name = 'add_new_ad_auto_for_parts_test.py'
...
try:
    ...
    driver.find_element(By.XPATH,"//li/a[@href='/add/cars4parts/']").click()
    h1 = driver.find_element(By.TAG_NAME,"h1").text
    if h1 == "Разместить объявление о продаже автомобиля на запчасти":
        print('true')
    else:
        print('false')
    ...
    driver.find_element(By.XPATH,"//*[@id='f_mark']/option[4]").click()
    ...
    driver.find_element(By.XPATH, "//*[@id='add']/div[15]/div/div[1]/label[2]").click()
