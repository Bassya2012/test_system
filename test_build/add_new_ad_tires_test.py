...
try:
    ...
    if h1 == "Разместить объявление о продаже шины колеса":
        print('правильный раздел шины и колеса(ШИНЫ)')
    else:
        print('неправильный раздел шины и колеса(ШИНЫ)')

    driver.find_element(By.XPATH,"//*[@id='add']/div[1]/div/div[1]/label[2]").click()

    work(name)

    sleep(5)

    driver.find_element(By.ID,"f_wh_size").click()
    driver.find_element(By.XPATH,"//*[@id='f_wh_size']/option[11]").click()

    driver.find_element(By.ID,"f_wh_pcd").click()
    driver.find_element(By.XPATH,"//*[@id='f_wh_pcd']/option[5]").click()

    work(name)

    volume = driver.find_element(By.NAME, "wh_hole")
    volume.click()
    volume.send_keys('5')

    driver.find_element(By.XPATH,"//*[@id='add']/div[4]/div/div[1]/label[2]").click()

    driver.find_element(By.XPATH,"//*[@id='add']/div[5]/div/div[1]/label[1]").click()
